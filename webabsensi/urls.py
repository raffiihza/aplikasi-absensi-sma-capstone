...
urlpatterns = [
    ...
    path('jadwal/', views.manage_schedule, name='manage_schedule'),
    path('jadwal/tambah/', views.add_schedule, name='add_schedule'),
    path('jadwal/edit/<int:schedule_id>/', views.edit_schedule, name='edit_schedule'),
    path('jadwal/hapus/<int:schedule_id>/', views.delete_schedule, name='delete_schedule'),
